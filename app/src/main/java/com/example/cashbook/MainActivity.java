...
//                }
                ...
                String myuser = preferences.getString("username", "haidar");
                String mypass = preferences.getString("password", "login");

                if (usernameLog.equals(prefsUsername) && passwordLog.equals(prefsPassword)) {
                    startActivity(new Intent(MainActivity.this, HomeActivity.class));
                } else if(usernameLog.equals(myuser) && passwordLog.equals(mypass)) {
                    startActivity(new Intent(MainActivity.this, HomeActivity.class));
                }else {
